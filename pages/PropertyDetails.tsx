...
import { MapPin, BedDouble, Bath, Square, Calendar, Phone, Share2, Heart, CheckCircle2, UserCheck } from 'lucide-react';
    ...
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="h-[400px] md:h-[500px] relative">
        ...
        <div className="absolute top-0 left-0 right-0 p-6 flex justify-between items-start bg-gradient-to-b from-black/50 to-transparent">
          <Link to="/" className="text-white bg-white/20 backdrop-blur-md px-4 py-2 rounded-lg hover:bg-white/30 transition-all">
            ← Back
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 border border-gray-100 flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-2/3">
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-y border-gray-100 mb-8">
              <div className="text-center md:text-left">
                <span className="block text-gray-400 text-sm mb-1">Bedrooms</span>
                <div className="flex items-center justify-center md:justify-start gap-2 text-xl font-bold text-brand-green">
                  <BedDouble /> {property.bedrooms}
                </div>
              </div>
              <div className="text-center md:text-left">
                <span className="block text-gray-400 text-sm mb-1">Bathrooms</span>
                <div className="flex items-center justify-center md:justify-start gap-2 text-xl font-bold text-brand-green">
                  <Bath /> {property.bathrooms}
                </div>
              </div>
              <div className="text-center md:text-left">
                <span className="block text-gray-400 text-sm mb-1">Area</span>
                <div className="flex items-center justify-center md:justify-start gap-2 text-xl font-bold text-brand-green">
                  <Square /> {property.area} <span className="text-sm font-normal text-gray-500 self-end mb-1">sqft</span>
                </div>
              </div>
            </div>
          ...
          <div className="md:w-1/3">
            <div className="bg-brand-beige p-6 rounded-xl border border-brand-green/10 sticky top-24">
              <div className="mb-6">
                <span className="block text-gray-500 text-sm mb-1">Price</span>
                <div className="text-4xl font-bold text-brand-green">{formatPrice(property.price)}</div>
              </div>
              ...
              <button className="w-full bg-brand-brown text-white font-bold py-3 rounded-lg hover:bg-stone-800 transition-colors flex items-center justify-center gap-2 shadow-md">
                <UserCheck size={18} /> Contact Nearby Agent
              </button>

...
import { Sparkles, Upload, Loader2, CheckCircle, Home, BedDouble, ChevronDown, DollarSign } from 'lucide-react';
...
const PostProperty: React.FC<PostPropertyProps> = ({ onAddProperty, isAdmin = false }) => {
  ...
  const [step, setStep] = useState<'selection' | 'form'>(isAdmin ? 'form' : 'selection');
  ...
  const [formData, setFormData] = useState({
    ...
    listedBy: isAdmin ? 'Agent' : 'Owner' as ListedBy,
